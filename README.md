...
This repo contains an implementation of the speech recognition algorithms and data from my undergraduate final year project completed in 1987. The time-critical audio sampling routines and computationally demanding functions were originally implemented in 6502 Assembly along with some BASIC glue code. The code in this repo is a re-implementation of the speech recognition routines in K&R C.
...
It's a nice illustration of Moore's Law to note that a single speech recognition run comparing all 576 unknowns to the 32 references took about four hours on the 2MHz 6502-based microcomputer, about three hours on a PDP-11/84 minicomputer running 2.11BSD UNIX and about 30 seconds on an original Raspberry Pi Model B running Raspbian 7 (wheezy).
